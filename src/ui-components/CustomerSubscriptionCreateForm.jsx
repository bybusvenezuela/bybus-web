...
export default function CustomerSubscriptionCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new CustomerSubscription(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "CustomerSubscriptionCreateForm")}
      {...rest}
    >
      <TextField
        label="Name"
