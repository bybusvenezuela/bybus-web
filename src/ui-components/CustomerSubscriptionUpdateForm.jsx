...
export default function CustomerSubscriptionUpdateForm(props) {
  const {
    id: idProp,
    customerSubscription: customerSubscriptionModelProp,
    onSuccess,
    onError,
    onSubmit,
    onValidate,
  ...
  const resetStateValues = () => {
    const cleanValues = customerSubscriptionRecord
      ? { ...initialValues, ...customerSubscriptionRecord }
      : initialValues;
  ...
  const [customerSubscriptionRecord, setCustomerSubscriptionRecord] =
    React.useState(customerSubscriptionModelProp);
  React.useEffect(() => {
    const queryData = async () => {
      const record = idProp
        ? await DataStore.query(CustomerSubscription, idProp)
        : customerSubscriptionModelProp;
      setCustomerSubscriptionRecord(record);
    };
    queryData();
  }, [idProp, customerSubscriptionModelProp]);
  React.useEffect(resetStateValues, [customerSubscriptionRecord]);
  const validations = {
    name: [{ type: "Required" }],
    rif: [{ type: "Required" }],
    email: [{ type: "Required" }],
  ...
  return (
    <Grid
      ...
      {...getOverrideProps(overrides, "CustomerSubscriptionUpdateForm")}
      {...rest}
    >
      <TextField
        label="Name"
      ...
      >
        <Button
          ...
          isDisabled={!(idProp || customerSubscriptionModelProp)}
