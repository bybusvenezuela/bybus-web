...
export default function BookingCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setOfficeID(initialValues.officeID);
    setDepartureDate(initialValues.departureDate);
    setArrivalDate(initialValues.arrivalDate);
    setEstimatedTime(initialValues.estimatedTime);
    setDepartureLoc(initialValues.departureLoc);
    setDestinationLoc(initialValues.destinationLoc);
    setService(initialValues.service);
    setOwner(initialValues.owner);
    setOfficeOwner(initialValues.officeOwner);
    setErrors({});
  };
  const validations = {
    code: [],
